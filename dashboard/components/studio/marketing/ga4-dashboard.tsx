...
import { Ga4StudioComparison } from "@/components/studio/marketing/ga4-studio-comparison"
...
export function Ga4Dashboard() {
  ...
  return <div className="flex flex-col gap-6 p-4 md:p-6">
    ...
    {!loading && !error && data?.configured && data.studios.length > 0 && <Ga4StudioComparison data={data} />}

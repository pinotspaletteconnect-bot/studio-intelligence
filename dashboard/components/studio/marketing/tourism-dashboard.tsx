...
export function TourismDashboard() {
  ...
  return <div className="space-y-6">
    ...
    {loading?<Skeleton className="h-80"/>:error?<Card><CardContent className="py-12 text-center">{error}</CardContent></Card>:<div className="grid items-start gap-5 xl:grid-cols-2">{data?.studios.map(studio=><Card key={studio.studioId}><CardContent className="space-y-5">

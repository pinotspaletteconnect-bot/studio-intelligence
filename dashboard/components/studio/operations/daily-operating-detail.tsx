        ...
        <>
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {[
              ...
              ["Capacity", `${data.totals.percentFull.toFixed(1)}%`],
              [
                "Average lead time",
                ...
                <CardContent>
                  ...
                  <tbody>{studio.classes.map((row) => (
                    <tr key={row.id} className="border-b last:border-0">
                      ...
                      <td className="px-2 py-3 text-right tabular-nums">{currency.format(row.classSales)}</td>
